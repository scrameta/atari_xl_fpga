...
# ----------------------------------------
# If pll_aud is one of several IP cores in your
...
# ----------------------------------------
# ACDS 23.1 993 linux 2024.09.29.16:16:04
...
alias com {
  echo "\[exec\] com"
  eval  vcom $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/pll_aud.vho"
}
